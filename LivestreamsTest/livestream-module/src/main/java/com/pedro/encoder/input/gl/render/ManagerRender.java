...
public class ManagerRender {
    ...
    public void setImageThumbnail(Bitmap bitmap) {
        if (screenRender != null) {
            screenRender.setImageThumbnail(bitmap);
        }
    }
    ...
    public void drawScreen(boolean enable, int width, int height, boolean keepAspectRatio) {
        screenRender.draw(enable, width, height, keepAspectRatio);
    }
