...
public abstract class DisplayBase implements GetAacData, GetVideoData, GetMicrophoneData, CustomDataVideo {
     ...
     *                 com.sigma.live.encoder.
     *                 NOTE: Rotation with com.sigma.live.encoder is silence ignored in some devices.
    ...
    public OffScreenGlThread getOpenGl() {
        return glInterface;
    }
    ...
    public void stopStreamForReconnect() {
        if (streaming) {
            streaming = false;
            stopStreamRtp();
        }
