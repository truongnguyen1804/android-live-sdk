...
public abstract class Camera2Base implements GetAacData, GetVideoData, GetMicrophoneData, CustomDataVideo {
     ...
     * @param hardwareRotation true if you want rotate using com.sigma.live.encoder, false if you with OpenGl if you
